...
export const TestimonialLists = [
  ...
  },
  {
    name: "Pasang Sherpa",
    relation: "Student (2076)",
    text: '"The school’s vibrant community made learning enjoyable. I appreciated the balance of academics and extracurricular activities, which helped me develop leadership skills that I still use today."',
    image: testimony3,
  },
  {
    name: "Lila Jirel",
